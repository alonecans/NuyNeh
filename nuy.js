...
async function starts() {
   ...
   nuy.on('group-participants-update', async (anu) => {
      ...
      try {
         ...
         if (anu.action == 'add') {
            ...
            teks = `*_Hallo👋_* @${num.split('@')[0]}\nSelamat datang di group *${mdata.subject}*\nHarap Intro, Biar Member Lain Pada Kenal\nNote Dari Admin\nBaca Deskripsi!\n Jangan jadi kutu loncat yah!`;
            let buff = await getBuffer(ppimg);
            const loli = fs.readFileSync('./mp3/halo.mp3');
            nuy.sendMessage(from, loli, MessageType.audio, { quoted: nuy, mimetype: 'audio/mp4', ptt: true });
   ...
   nuy.on('chat-update', async (nuy) => {
      try {
         if (!nuy.hasNewMessage) return;
         nuy = JSON.parse(JSON.stringify(nuy)).messages[0];
         if (!nuy.message) return;
         if (nuy.key && nuy.key.remoteJid == 'status@broadcast') return;
         if (nuy.key.fromMe) return;
         global.prefix;
         global.blocked;
         const content = JSON.stringify(nuy.message);
         const from = nuy.key.remoteJid;
         const type = Object.keys(nuy.message)[0];
         const Nurul = ['0@s.whatsapp.net']; // ubah aja gapapa
         const manca = nuy.message.conversation;
         const insom = from.endsWith('@g.us');
         const nameReq = insom ? nuy.participant : nuy.key.remoteJid;
         ...
         body =
            type === 'conversation' && nuy.message.conversation.startsWith(prefix)
               ? nuy.message.conversation
               : type == 'imageMessage' && nuy.message.imageMessage.caption.startsWith(prefix)
               ? nuy.message.imageMessage.caption
               : type == 'videoMessage' && nuy.message.videoMessage.caption.startsWith(prefix)
               ? nuy.message.videoMessage.caption
               : type == 'extendedTextMessage' && nuy.message.extendedTextMessage.text.startsWith(prefix)
               ? nuy.message.extendedTextMessage.text
               : '';
         budy = type === 'conversation' ? nuy.message.conversation : type === 'extendedTextMessage' ? nuy.message.extendedTextMessage.text : '';
         var Link =
            type === 'conversation' && nuy.message.conversation
               ? nuy.message.conversation
               : type == 'imageMessage' && nuy.message.imageMessage.caption
               ? nuy.message.imageMessage.caption
               : type == 'videoMessage' && nuy.message.videoMessage.caption
               ? nuy.message.videoMessage.caption
               : type == 'extendedTextMessage' && nuy.message.extendedTextMessage.text
               ? nuy.message.extendedTextMessage.text
               : '';
         ...
         const sender = isGroup ? nuy.participant : nuy.key.remoteJid;
         ...
         const reply = (teks) => {
            nuy.sendMessage(from, teks, text, { quoted: nuy });
         };
         const sendMess = (hehe, teks) => {
            nuy.sendMessage(hehe, teks, text);
         };
         const sendPtt = (teks) => {
            nuy.sendMessage(from, audio, mp3, { quoted: nuy });
         };
         ...
         const mentions = (teks, memberr, id) => {
            id == null || id == undefined || id == false
               ...
               : nuy.sendMessage(from, teks.trim(), extendedText, { quoted: nuy, contextInfo: { mentionedJid: memberr } });
         };
         ...
         const checkLimit = (sender) => {
            ...
            if (found === false) {
               ...
               nuy.sendMessage(from, limitcount(limitCounts), text, { quoted: nuy });
            }
         };
         if (isGroup) {
            try {
         ...
         const isLimit = (sender) => {
            ...
            for (let i of _limit) {
               if (i.id === sender) {
                  ...
                  if (limits >= limitt) {
                     position = true;
                     nuy.sendMessage(from, limitend(pushname2), text, { quoted: nuy });
                     return true;
                  } else {
                     _limit;
                     position = true;
         ...
         if (messagesLink.includes('manca')) {
            nuy.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/iyh kak.mp3');
            nuy.sendMessage(from, loli, MessageType.audio, { quoted: nuy, mimetype: 'audio/mp4', ptt: true });
         }
         ...
         if (messagesLink.includes('#ngewe')) {
            ...
            nuy.sendMessage(from, d, sticker, { quoted: nuy });
         }
         ...
         if (bad.includes(messagesLink)) {
            // respon badword
            reply(`*Ku Kick Nanti Mau?\nHehehe*`);
            const d = fs.readFileSync('./sticker/admin.webp');
            nuy.sendMessage(from, d, sticker, { quoted: nuy });
         }
         if (bad.includes(messagesLink)) {
            nuy.updatePresence(from, Presence.composing);
...
۝♡ۣۜۜ፝͜͜͡͡✿➤ KALO GA ADA DI MENU JANGAN KETIK!`,
               nuy.sendMessage(from, Menu, image, { quoted: nuy, caption: text });
               break;
            case 'zodiak':
            ...
            case 'cyberpunk':
               ...
               try {
                  ...
                  ninuy = n[Math.floor(Math.random() * n.length)];
                  pok = await getBuffer(ninuy);
            ...
            case 'wasted':
               ...
               if (((isMedia && !nuy.message.videoMessage) || isQuotedImage) && args.length == 0) {
                  ger = isQuotedImage ? JSON.parse(JSON.stringify(nuy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : nuy;
                  reply(mess.wait);
            ...
            case 'drawing':
               ...
               var imgbb = require('imgbb-uploader');
               if (((isMedia && !nuy.message.videoMessage) || isQuotedImage) && args.length == 0) {
                  ted = isQuotedImage ? JSON.parse(JSON.stringify(nuy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : nuy;
                  reply(mess.wait);
                  ...
                  nuy.sendMessage(from, hehe, image, { quoted: nuy });
               } else {
            ...
            case 'cantik':
               ...
               break;
            case 'slow':
               encmedia = JSON.parse(JSON.stringify(nuy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo;
               ...
               exec(`ffmpeg -i ${media} -filter:a 'atempo=0.7,asetrate=44100' ${ran}`, (err, stderr, stdout) => {
                  ...
                  nuy.sendMessage(from, hah, audio, { mimetype: 'audio/mp4', ptt: true, quoted: nuy });
                  fs.unlinkSync(ran);
               });
               break;
            case 'gemuk':
            ...
            case 'brainly':
               ...
               brainly(`${brien}`).then((res) => {
                  ...
                  nuy.sendMessage(from, teks, text, { quoted: nuy, detectLinks: false });
                  console.log(res);
               });
               await limitAdd(sender);
               break;
            case 'daftar':
               ...
               nuy.sendMessage(from, daftarimg, image, { quoted: nuy, caption: captionnya });
               break;
            case 'help':
               if (!isUser) return reply(mess.only.userB);
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'profile':
               ...
               nuy.sendMessage(from, buff, image, { quoted: nuy, caption: profile });
               break;
            ...
            case 'bahasa':
               ...
               nuy.sendMessage(from, bahasa(prefix), text, { quoted: nuy });
               break;
            case 'donasi':
            case 'donate':
               nuy.sendMessage(from, donasi(name), text, { quoted: nuy });
               break;
            case 'info':
               me = nuy.user;
               user.push(sender);
               ...
               nuy.sendMessage(from, daca, image, { quoted: nuy, caption: teks });
               break;
            case 'totaluser':
               nuy.updatePresence(from, Presence.composing);
               ...
               nuy.sendMessage(from, teks.trim(), extendedText, { quoted: nuy, contextInfo: { mentionedJid: user } });
               break;
            case 'blocklist':
               teks = 'List Block :\n';
               ...
               nuy.sendMessage(from, teks.trim(), extendedText, { quoted: nuy, contextInfo: { mentionedJid: blocked } });
               break;
            case 'banlist':
               ben = '```List Banned``` :\n';
               ...
               nuy.sendMessage(from, ben.trim(), extendedText, { quoted: nuy, contextInfo: { mentionedJid: ban } });
               break;
            case 'premiumlist':
               nuy.updatePresence(from, Presence.composing);
               ...
               nuy.sendMessage(from, teks.trim(), extendedText, { quoted: nuy, contextInfo: { mentionedJid: premium } });
               break;
            case 'ban':
               nuy.updatePresence(from, Presence.composing);
            ...
            case 'tahta':
               ...
               nuy.sendMessage(from, buffer, image, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'shadow': 
            case 'cup':
            ...
            case 'addprem':
               ...
               if (args.length < 1) return;
               if (!isOwner) return reply(mess.only.ownerB);
               addpremium = nuy.message.extendedTextMessage.contextInfo.mentionedJid;
               premium = addpremium;
            ...
            case 'ocr':
               if (((isMedia && !nuy.message.videoMessage) || isQuotedImage) && args.length == 0) {
                  const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(nuy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : nuy;
               ...
               if (((isMedia && !nuy.message.videoMessage) || isQuotedImage) && args.length == 0) {
                  ...
                  await ffmpeg(`./${media}`)
                     ...
                     .on('end', function () {
                        ...
                        nuy.sendMessage(from, buff, sticker, { quoted: nuy });
                        fs.unlinkSync(media);
                        fs.unlinkSync(ran);
                     })
                     .addOutputOptions([
                     ...
                     .toFormat('webp')
                     .save(ran);
               } else if (((isMedia && nuy.message.videoMessage.seconds < 11) || (isQuotedVideo && nuy.message.extendedTextMessage.contextInfo.quotedMessage.videoMessage.seconds < 11)) && args.length == 0) {
                  const encmedia = isQuotedVideo ? JSON.parse(JSON.stringify(nuy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : nuy;
                  const media = await nuy.downloadAndSaveMediaMessage(encmedia);
                  ran = getRandom('.webp');
                  reply(mess.wait);
                  await ffmpeg(`./${media}`)
            ...
            case 'trigger':
               ...
               if (((isMedia && !nuy.message.videoMessage) || isQuotedImage) && args.length == 0) {
                  ...
                  exec(`wget ${anu1} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
                     ...
                     if (err) return reply(mess.error.stick);
                     nobg = fs.readFileSync(rano);
                     nuy.sendMessage(from, nobg, sticker, { quoted: nuy });
                     fs.unlinkSync(rano);
                  });
               } else {
                  reply('Gunakan foto!');
            ...
            case 'img2url':
               ...
               if (isLimit(sender)) return reply(limitend(pushname2));
               reply(mess.wait);
               var encmedia = isQuotedImage ? JSON.parse(JSON.stringify(nuy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : nuy;
               ...
               imgbb('727e7e43f6cda1dfb85d888522fd4ce1', media)
                  .then((data) => {
                     ...
                     nuy.sendMessage(from, ibb, image, { quoted: nuy, caption: caps });
                  })
                  .catch((err) => {
                     throw err;
                  });
            ...
            case 'kalkulator':
               ...
               nuy.sendMessage(from, `*${anu.result.data}*`, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'owner':
               nuy.sendMessage(from, { displayname: 'jeff', vcard: vcard }, MessageType.contact, { quoted: nuy });
               nuy.sendMessage(from, '*Tuh owner ku nama nya Nurul, jangan spam, di blok nanti nangis:V*', text, { quoted: nuy });
               break;
            case 'fitnah':
               if (isBanned) return reply(mess.only.benned);
               if (!isUser) return reply(mess.only.userB);
            ...
            case 'grupinfo':
               ...
               nuy.sendMessage(from, buffer, image, { quoted: nuy, caption: `*NAME* : ${groupName}\n*MEMBER* : ${groupMembers.length}\n*ADMIN* : ${groupAdmins.length}\n*DESK* : ${groupDesc}` });
               break;
            case 'trendtwit':
               nuy.updatePresence(from, Presence.composing);
               if (!isUser) return reply(mess.only.userB);
            ...
            case 'testime':
               setTimeout(() => {
                  nuy.sendMessage(from, 'Waktu habis:v', text, { quoted: nuy }); // ur cods
               }, 10000); // 1000 = 1s,
               setTimeout(() => {
                  nuy.sendMessage(from, '5 Detik lagi', text, { quoted: nuy }); // ur cods
               }, 5000); // 1000 = 1s,
               setTimeout(() => {
                  nuy.sendMessage(from, '10 Detik lagi', text, { quoted: nuy }); // ur cods
               }, 0); // 1000 = 1s,
               break;
            case 'neonime':
               nuy.updatePresence(from, Presence.composing);
            ...
            case 'animehug':
               ...
               exec(`wget ${anu.result} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
                  ...
                  nuy.sendMessage(from, buffer, sticker, { quoted: nuy });
                  fs.unlinkSync(rano);
               });
               await limitAdd(sender);
               break;
            ...
            case 'grouplink':
               ...
               nuy.sendMessage(from, yeh, text, { quoted: nuy });
               break;
            case 'hidetag':
               if (isBanned) return reply(mess.only.benned);
               if (!isUser) return reply(mess.only.userB);
            ...
            case 'ownergroup':
               ...
               nuy.sendMessage(from, options, text, { quoted: nuy });
               break;
            case 'leave':
               if (!isGroup) return reply(mess.only.group);
               if (!isOwner) return reply(mess.only.ownerB);
            ...
            case 'setname':
               ...
               nuy.sendMessage(from, `\`\`\`âœ“Sukses Mengganti Nama Group Menjadi\`\`\` *${body.slice(9)}*`, text, { quoted: nuy });
               break;
            case 'setdesc':
               if (isBanned) return reply(mess.only.benned);
               if (!isUser) return reply(mess.only.userB);
               ...
               nuy.sendMessage(from, `\`\`\`âœ“Sukses Mengganti Deskripsi Group\`\`\` *${groupMetadata.subject}* Menjadi: *${body.slice(9)}*`, text, { quoted: nuy });
               break;
            case 'tts':
               if (isBanned) return reply(mess.only.benned);
               if (!isUser) return reply(mess.only.userB);
               ...
               if (isLimit(sender)) return reply(limitend(pushname2));
               if (args.length < 1) return nuy.sendMessage(from, 'Kode bahasanya mana kak?\n Kalo Gatau Kode Bahasanya Apa Aja Ketik Saja *${prefix}bahasa*', text, { quoted: nuy });
               const gtts = require('./lib/gtts')(args[0]);
               if (args.length < 2) return nuy.sendMessage(from, 'Textnya mana kak?', text, { quoted: nuy });
               dtt = body.slice(9);
               ranm = getRandom('.mp3');
               rano = getRandom('.ogg');
               dtt.length > 600
                  ...
                  : gtts.save(ranm, dtt, function () {
                       exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
                          ...
                          reply(mess.wait);
                          nuy.sendMessage(from, buff, audio, { quoted: nuy, ptt: true });
                          fs.unlinkSync(rano);
                       });
                    });
               await limitAdd(sender);
            ...
            case 'translete':
               ...
               if (isLimit(sender)) return reply(limitend(pushname2));
               if (args.length < 1) return nuy.sendMessage(from, 'Kode Bahasanya???', text, { quoted: nuy });
               if (args.length < 2) return nuy.sendMessage(from, 'Text Yg Mau Di translate??', text, { quoted: nuy });
               ts = body.slice(11);
               kode = ts.split('/')[0];
               teks = ts.split('/')[1];
               ...
               nuy.sendMessage(from, translate, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'ts':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, ts, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'setpp':
               if (isBanned) return reply(mess.only.benned);
               ...
               if (!isGroupAdmins) return reply(mess.only.admin);
               if (!isBotGroupAdmins) return reply(mess.only.Badmin);
               media = await nuy.downloadAndSaveMediaMessage(nuy);
            ...
            case 'dare':
               ...
               nuy.sendMessage(from, tod, image, { quoted: nuy, caption: '*Dare*\n\n' + der });
               await limitAdd(sender);
               break;
            case 'speed':
            case 'ping':
               ...
               nuy.sendMessage(from, `Speed: ${latensi.toFixed(4)} _Second_`, text, { quoted: nuy });
               break;
            case 'tagme':
               if (isBanned) return reply(mess.only.benned);

               if (!isUser) return reply(mess.only.userB);
               var nom = nuy.participant;
               const tag = {
                  text: `@${nom.split('@s.whatsapp.net')[0]} tag!`,
                  contextInfo: { mentionedJid: [nom] },
               };
               nuy.sendMessage(from, tag, text, { quoted: nuy });
               break;
            case 'lirik':
               ...
               nuy.sendMessage(from, thum, image, { quoted: nuy, caption: teks });
               break;
            case 'report':
               if (isBanned) return reply(mess.only.benned);
               if (!isUser) return reply(mess.only.userB);
               ...
               if (pesan.length > 300) return nuy.sendMessage(from, 'Maaf Teks Terlalu Panjang, Maksimal 300 Teks', text, { quoted: nuy });
               var nomor = nuy.participant;
               ...
               nuy.sendMessage('6283815956151@s.whatsapp.net', options, text, { quoted: nuy });
            ...
            case 'request':
               ...
               if (cfrr.length > 300) return nuy.sendMessage(from, 'Maaf Teks Terlalu Panjang, Maksimal 300 Teks', text, { quoted: nuy });
               var nomor = nuy.participant;
            ...
            case 'memeindo':
               ...
               nuy.sendMessage(from, buffer, image, { quoted: nuy, caption: '.......' });
               await limitAdd(sender);
               break;
            case 'ssweb':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, ssweb, image, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'neko':
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'loli':
               ...
               nuy.sendMessage(from, nye, image, { caption: '*Loli*', quoted: nuy });
               await limitAdd(sender);
               break;
            case 'nsfwloli':
               try {
                  ...
                  nuy.sendMessage(from, buffer, image, { quoted: nuy, caption: 'Jangan jadiin bahan buat comli om' });
               } catch (e) {
            ...
            case 'nsfwneko':
               try {
                  ...
                  buffer = await getBuffer(res.result);
                  nuy.sendMessage(from, buffer, image, { quoted: nuy, caption: 'Nih Kak Bokep Nsfw Neko Nya Xixixi' });
               } catch (e) {
                  console.log(`Error :`, color(e, 'red'));
                  reply(' *ERROR* ');
               }
            ...
            case 'nsfwtrap':
               try {
                  ...
                  buffer = await getBuffer(res.result);
                  nuy.sendMessage(from, buffer, image, { quoted: nuy, caption: 'Nih Kak Bokep Nsfw Trap Nya Xixixi' });
               } catch (e) {
                  console.log(`Error :`, color(e, 'red'));
                  reply(' *ERROR* ');
               }
            ...
            case 'hentai':
               try {
                  ...
                  buffer = await getBuffer(res.result);
                  nuy.sendMessage(from, buffer, image, { quoted: nuy, caption: 'Nih Kak Bokep Nsfw Hentai Nya Xixixi' });
               } catch (e) {
                  console.log(`Error :`, color(e, 'red'));
                  reply(' *ERROR* ');
               }
            ...
            case 'hilih':
               ...
               nuy.sendMessage(from, `${anu.result}`, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'chord':
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'infogempa':
               ...
               nuy.sendMessage(from, buff, image, { quoted: nuy, caption: gempa });
               await limitAdd(sender);
               break;
            case 'kucing':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, buff, image, { quoted: nuy, caption: 'meong🐈' });
               await limitAdd(sender);
               break;
            ...
            case 'anime':
               ...
               nuy.sendMessage(from, pok, image, { quoted: nuy, caption: 'nihhh' });
               await limitAdd(sender);
               break;
            case 'naruto':
               if (isBanned) return reply(mess.only.benned);
               ...
               to = naru[Math.floor(Math.random() * naru.length)];
               nye = await getBuffer(to);
               nuy.sendMessage(from, nye, image, { caption: 'naruto!!', quoted: nuy });
               await limitAdd(sender);
               break;
            case 'minato':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, nye, image, { caption: 'minato!!', quoted: nuy });
               await limitAdd(sender);
               break;
            case 'boruto':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, nye, image, { caption: 'boruto!!', quoted: nuy });
               await limitAdd(sender);
               break;
            case 'hinata':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, nye, image, { caption: 'hinata!!', quoted: nuy });
               await limitAdd(sender);
               break;
            case 'sasuke':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, nye, image, { caption: 'sasuke!!', quoted: nuy });
               await limitAdd(sender);
               break;
            case 'sakura':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, nye, image, { caption: 'sakura!!', quoted: nuy });
               await limitAdd(sender);
               break;
            ...
            case 'kaneki':
               ...
               nuy.sendMessage(from, ki, image, { caption: 'kaneki!!', quoted: nuy });
               await limitAdd(sender);
               break;
            case 'toukachan':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, nye, image, { caption: 'toukachan!!', quoted: nuy });
               await limitAdd(sender);
               break;
            case 'rize':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, nye, image, { caption: 'rize chan!!', quoted: nuy });
               await limitAdd(sender);
               break;
            case 'akira':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, nye, image, { caption: 'akira chan!!', quoted: nuy });
               await limitAdd(sender);
               break;
            case 'itori':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, nye, image, { caption: 'itori chan!!', quoted: nuy });
               await limitAdd(sender);
               break;
            case 'kurumi':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, nye, image, { caption: 'kurumi chan!!', quoted: nuy });
               await limitAdd(sender);
               break;
            case 'miku':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, nye, image, { caption: 'miku chan!!', quoted: nuy });
               await limitAdd(sender);
               break;
            // akhir fitur anime
            ...
            case 'anjing':
               ...
               ninuy = n[Math.floor(Math.random() * n.length)];
               pok = await getBuffer(ninuy);
               nuy.sendMessage(from, pok, image, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'resepmasakan':
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'cersex':
               ...
               nuy.sendMessage(from, sex, image, { quoted: nuy, caption: cerita });
               await limitAdd(sender);
               break;
            case 'randomkpop':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, buff, image, { quoted: nuy });
               break;
            case 'puisiimg':
               if (isBanned) return reply(mess.only.benned);
               if (!isUser) return reply(mess.only.userB);
               ...
               nuy.sendMessage(from, pus, image, { quoted: nuy });
               break;
            case 'playstore':
               if (isBanned) return reply(mess.only.benned);
               if (!isUser) return reply(mess.only.userB);
            ...
            case 'fb':
               ...
               if (anu.error) return reply(anu.error);
               nuy.sendMessage(from, '[ WAIT ] Sedang Diproses\n\nLinknya Only Google kak Biar Bisa Didownload', text, { quoted: nuy });
               efbe = `Title: *${anu.title}*\nSize: *${anu.filesize}\nDipublikasikan Pada: *${anu.published}*`;
               tefbe = await getBuffer(anu.thumb);
               nuy.sendMessage(from, tefbe, image, { quoted: nuy, caption: efbe });
               buffer = await getBuffer(anu.result);
               nuy.sendMessage(from, buffer, video, { mimetype: 'video/mp4', quoted: nuy, caption: 'Nih kak' });
               await limitAdd(sender);
               break;
            case 'instaimg':
               if (isBanned) return reply(mess.only.benned);
               ...
               reply(mess.wait);
               nuy.sendMessage(from, insta, image, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'bass':
               encmedia = JSON.parse(JSON.stringify(nuy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo;
            ...
            case 'instavid':
               ...
               insta = getBuffer(anu.result);
               reply(mess.wait);
               nuy.sendMessage(from, insta, video, { mimtype: 'video/mp4', filename: 'instagram'.mp3, quoted: nuy });
               await limitAdd(sender);
               break;
            case 'instastory':
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'hekerbucin':
               ...
               nuy.sendMessage(from, '*' + hasil + '*', text, { quoted: nuy });
               await limitAdd(sender);
               break;
            ...
            case 'tiktok':
               ...
               if (anu.error) return reply(anu.error);
               buffer = await getBuffer(anu.result);
               nuy.sendMessage(from, buffer, video, { quoted: nuy });
               break;
            ...
            case 'tiktokstalk':
               try {
                  ...
                  if (isLimit(sender)) return reply(limitend(pushname2));
                  if (args.length < 1) return nuy.sendMessage(from, 'Usernamenya mana kak?', text, { quoted: nuy });
                  let { user, stats } = await tiktod.getUserProfileInfo(args[0]);
                  reply(mess.wait);
                  teks = `*ID* : ${user.id}\n*Username* : ${user.uniqueId}\n*Nickname* : ${user.nickname}\n*Followers* : ${stats.followerCount}\n*Followings* : ${stats.followingCount}\n*Posts* : ${stats.videoCount}\n*Menyukai* : ${stats.heart}\n`;
                  buffer = await getBuffer(user.avatarLarger);
                  nuy.sendMessage(from, buffer, image, { quoted: nuy, caption: teks });
               } catch (e) {
                  console.log(`Error :`, color(e, 'red'));
            ...
            case 'tulis':
               ...
               nuy.sendMessage(from, nulis, image, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'ttp':
               if (isBanned) return reply(mess.only.benned);
               ...
               exec(`wget ${anu.result} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
                  ...
                  nuy.sendMessage(from, bufferhgf, sticker, { quoted: nuy });
                  fs.unlinkSync(rano);
               });
               await limitAdd(sender);
               break;
            ...
            case 'slide':
               ...
               reply(mess.wait);
               nuy.sendMessage(from, atytyd, video, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'quotemaker':
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'igstalk':
               ...
               nuy.sendMessage(from, buffer, image, { quoted: nuy, caption: hasil });
               await limitAdd(sender);
               break;
            case 'mimpi':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, mimpi, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'quotes':
               nuy.updatePresence(from, Presence.composing);
               ...
               nuy.sendMessage(from, randQuote, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'fakta':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, fakta, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'katabijak':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, katabijak, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            ...
            case 'profiltiktok':
               ...
               nuy.sendMessage(from, tiktok, image, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'closetime':
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'darkjokes':
               ...
               nuy.sendMessage(from, darkjokes, image, { quoted: nuy, caption: '```DARK JOKES```' });
               await limitAdd(sender);
               break;
            case 'katailham':
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'addsticker':
               ...
               boij = JSON.parse(JSON.stringify(nuy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo;
               delb = await nuy.downloadMediaMessage(boij);
               fs.writeFileSync(`./sticker/${svst}.webp`, delb);
               nuy.sendMessage(from, `Berhasil menyimpan sticker!`, MessageType.text, { quoted: nuy });
               break;
            case 'addaudio':
               if (!isOwner) return reply(mess.only.ownerB);
               ...
               uyw = JSON.parse(JSON.stringify(nuy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo;
            ...
            case 'katacinta':
               ...
               katacin = `*${anu.result}*`;
               nuy.sendMessage(from, katacin, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            ...
            case 'pasangan':
               ...
               nuy.sendMessage(from, `${anu.result.hasil}`, { quoted: nuy });
               await limitAdd(sender);
               break;
            ...
            case 'url2img':
               ...
               nuy.sendMessage(from, url2img, image, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'tagall':
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'bcgc':
               ...
               if ((isMedia && !nuy.message.videoMessage) || isQuotedImage) {
                  const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(nuy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : nuy;
            ...
            case 'kick':
               ...
               if (!isGroupAdmins) return reply(mess.only.admin);
               if (!isBotGroupAdmins) return reply(mess.only.Badmin);
               if (nuy.message.extendedTextMessage === undefined || nuy.message.extendedTextMessage === null) return reply('Tag target yang ingin di tendang!');
               mentioned = nuy.message.extendedTextMessage.contextInfo.mentionedJid;
            ...
            case 'pm':
               ...
               if (!isGroupAdmins) return reply(mess.only.admin);
               if (!isBotGroupAdmins) return reply(mess.only.Badmin);
               if (nuy.message.extendedTextMessage === undefined || nuy.message.extendedTextMessage === null) return reply('Tag target yang ingin di jadi admin!');
               mentioned = nuy.message.extendedTextMessage.contextInfo.mentionedJid;
               if (mentioned.length > 1) {
            ...
            case 'd':
               if (!isGroup) return reply(mess.only.group);
               if (!isGroupAdmins) return reply(mess.only.admin);
               nuy.deleteMessage(from, { id: nuy.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true });
               break;
            case 'demote':
               if (isBanned) return reply(mess.only.benned);
               if (!isUser) return reply(mess.only.userB);
               ...
               if (!isGroupAdmins) return reply(mess.only.admin);
               if (!isBotGroupAdmins) return reply(mess.only.Badmin);
               if (nuy.message.extendedTextMessage === undefined || nuy.message.extendedTextMessage === null) return reply('Tag target yang ingin di tidak jadi admin!');
               mentioned = nuy.message.extendedTextMessage.contextInfo.mentionedJid;
               if (mentioned.length > 1) {
            ...
            case 'toimg':
               ...
               exec(`ffmpeg -i ${media} ${ran}`, (err) => {
                  ...
                  nuy.sendMessage(from, buffer, image, { quoted: nuy, caption: 'nihhh' });
                  fs.unlinkSync(ran);
               });
               await limitAdd(sender);
               break;
            ...
            case 'caklontong':
               ...
               setTimeout(() => {
                  nuy.sendMessage(from, '*➸ Jawaban :* ' + anu.result.jawaban + '\n\n• Penjelasan: *' + anu.result.desk + '*', text, { quoted: nuy }); // ur cods
               }, 30000); // 1000 = 1s,
               setTimeout(() => {
               ...
               setTimeout(() => {
                  nuy.sendMessage(from, caklontong, text, { quoted: nuy }); // ur cods
               }, 0); // 1000 = 1s,
               await limitAdd(sender);
               break;
            case 'tebakgambar':
               ...
               setTimeout(() => {
                  nuy.sendMessage(from, '*➸ Jawaban :* ' + anu.result.jawaban, text, { quoted: nuy }); // ur cods
               }, 30000); // 1000 = 1s,
               setTimeout(() => {
                  nuy.sendMessage(from, '_10 Detik lagi…_', text); // ur cods
               }, 20000); // 1000 = 1s,
               ...
               setTimeout(() => {
                  nuy.sendMessage(from, bufferkkk, image, { caption: '_Jelaskan Apa Maksud Gambar Ini_', quoted: nuy }); // ur cods
               }, 0); // 1000 = 1s,
               await limitAdd(sender);
               break;
            case 'family100':
               ...
               setTimeout(() => {
                  nuy.sendMessage(from, family, text, { quoted: nuy }); // ur cods
               }, 0); // 1000 = 1s,
               await limitAdd(sender);
               break;
            case 'randombokep':
               ...
               nuy.sendMessage(from, randBokep, image, { quoted: nuy, caption: randTeks });
               await limitAdd(sender);
               break;
            ...
            case 'clone':
               ...
               if (nuy.message.extendedTextMessage === undefined || nuy.message.extendedTextMessage === null) return reply('Tag kak');
               mentioned = nuy.message.extendedTextMessage.contextInfo.mentionedJid[0];
            ...
            case 'wait':
               ...
               if (((isMedia && !nuy.message.videoMessage) || isQuotedImage) && args.length == 0) {
                  ...
                  await wait(media)
                     .then((res) => {
                        nuy.sendMessage(from, res.video, video, { quoted: nuy, caption: res.teks.trim() });
                     })
                     .catch((err) => {
                        reply(err);
                     });
            ...
            case 'quran':
               ...
               nuy.sendMessage(from, quran, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'infocuaca':
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'jadwalsholat':
               ...
               nuy.sendMessage(from, jsol, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'jadwaltvnow':
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'joox':
               ...
               nuy.sendMessage(from, bufferddd, image, { quoted: nuy, caption: infomp3 });
               nuy.sendMessage(from, buff, audio, { mimetype: 'audio/mp4', filename: `${anu.result.judul}.mp3`, quoted: nuy });
               await limitAdd(sender);
               break;
            ...
            case 'snack':
               ...
               reply(mess.wait);
               buff = await getBuffer(anu.result);
               nuy.sendMessage(from, bufferddd, image, { quoted: nuy, caption: sck });
               nuy.sendMessage(from, buff, video, { mimetype: 'video/mp4', filename: `${anu.format}.mp4`, quoted: nuy });
               await limitAdd(sender);
               break;
            ...
            case 'ytmp4':
               ...
               nuy.sendMessage(from, buff, image, { quoted: nuy, caption: ytt });
               nuy.sendMessage(from, buffer, video, { mimetype: 'video/mp4', filename: `${anu.result.title}.mp4`, quoted: nuy, caption: 'Nih kak' });
               await limitAdd(sender);
               break;
            ...
            case 'ytmp3':
               ...
               nuy.sendMessage(from, buff, image, { quoted: nuy, caption: yta });
               nuy.sendMessage(from, buffer, audio, { mimetype: 'audio/mp4', filename: `${anu.result.title}.mp3`, quoted: nuy, caption: 'Nih kak' });
               await limitAdd(sender);
               break;
            ...
            case 'playmp3':
               ...
               nuy.sendMessage(from, bufferddd, image, { quoted: nuy, caption: infomp3 });
               nuy.sendMessage(from, lagu, audio, { mimetype: 'audio/mp4', filename: `${data.result.title}.mp3`, quoted: nuy });
               break;
            ...
            case 'smule':
               ...
               nuy.sendMessage(from, thumb, image, { quoted: nuy, caption: teks });
               buffer = await getBuffer(anu.result);
               nuy.sendMessage(from, buffer, video, { mimetype: 'video/mp4', filename: `${anu.title}.mp4`, quoted: nuy, caption: 'Nih kak' });
               await limitAdd(sender);
               break;
            ...
            case 'wiki':
               ...
               if (anu.error) return reply(anu.error);
               wikii = `${anu.result}`;
               nuy.sendMessage(from, wikii, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            ...
            case 'spamcall':
               ...
               nuy.sendMessage(from, `${anu.result.logs}`, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'spamgmail':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, `${anu.result.log_lengkap}`, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'quransurah':
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'bitly':
               ...
               bitly = `${bitlyy.result}`;
               nuy.sendMessage(from, anu, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            case 'textstyle':
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'jamdunia':
               ...
               wtime = `*${anu.timezone}*\n*${anu.date}*\n*${anu.time}*`;
               nuy.sendMessage(from, wtime, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            ...
            case 'tomp3':
               ...
               exec(`ffmpeg -i ${media} ${ran}`, (err) => {
                  ...
                  nuy.sendMessage(from, bufferlkj, audio, { mimetype: 'audio/mp4', quoted: nuy });
                  fs.unlinkSync(ran);
               });
               await limitAdd(sender);
               break;
            case 'tomp4':
               ...
               reply(mess.wait);
               anumedia = JSON.parse(JSON.stringify(nuy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo;
            ...
            case 'setppbot':
               ...
               enmedia = JSON.parse(JSON.stringify(nuy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo;
            ...
            case 'hashidentifier':
               ...
               nuy.sendMessage(from, hasilhash, text, { quoted: nuy });
               await limitAdd(sender);
               break;
            ...
            case 'husbu':
               ...
               try {
                  ...
                  nuy.sendMessage(from, buffer, image, { quoted: nuy, caption: 'Ingat! Cintai Husbumu' });
               } catch (e) {
                  console.log(`Error :`, color(e, 'red'));
                  reply(' *ERROR* ');
               }
